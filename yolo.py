...
class YOLO(object):
    _defaults = {
        # "model_path"        : pthpath,#',#Epoch300-Total_Loss2.0316-Val_Loss2.5010.pth',#model128_final.pth',#model_final.pth',
    ...
    #   初始化YOLO
    #---------------------------------------------------#
    def __init__(self, pthpath, outpath, **kwargs):
        self.__dict__.update(self._defaults)
        self.model_path  = pthpath
    ...
    def detect_image(self, image, image_id):
        ...
        if  not os.path.exists(self.outpath+"/detection-results_data/"):
            os.mkdir(self.outpath+"/detection-results_data/")
        f = open(self.outpath+"/detection-results_data/"+image_id+".txt","w") 
