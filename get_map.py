...
GT_PATH = os.path.join(os.getcwd(), 'input', 'ground-truth_data3')
DR_PATH = os.path.join(os.getcwd(), 'input', 'detection-results_data3')
    ...
    for txt_file in dr_files_list:
        ...
        for line in lines:
            try:
                ...
                #confidence, tmp_class_name, left, top, right, bottom = line.split()
            except:
                line_split = line.split()
                bottom = line_split[-1]
                right = line_split[-2]
